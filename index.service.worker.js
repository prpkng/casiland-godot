...
/** @type {string} */
const CACHE_VERSION = '1741651939|11512359';
/** @type {string} */
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","liblimboai.web.template_release.wasm32.nothreads.wasm"];
