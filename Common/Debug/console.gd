...
func _enter_tree() -> void:
	...
	control.scale = Vector2(1.0/SCALE, 1.0/SCALE)
	control.anchor_bottom = SCALE
	control.anchor_right = SCALE
	...
	rich_label.add_theme_font_override("normal_font", load("res://Common/Debug/monogram-extended.ttf"))
	rich_label.add_theme_font_override("italics_font", load("res://Common/Debug/monogram-extended-italic.ttf"))
	...
	line_edit.add_theme_font_override("font", load("res://Common/Debug/monogram-extended.ttf"))
